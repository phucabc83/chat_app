class AppRouteInfor {
  ...
  static const String outGoingCallName= 'out_going_call';

  static const String incomingCallPath = '/incoming_call/:id';
  static const String incomingCallName= 'incoming_call';
